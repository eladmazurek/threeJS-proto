/**
 * MMSI Maritime Identification Digits (MID) Mapping
 * Maps the first 3 digits of an MMSI to a country name.
 * 
...
export const MID_TO_COUNTRY: Record<string, string> = {
  ...
  // North/Central America & Caribbean (301-374)
  "301": "Anguilla",
  "303": "Alaska",
...
/**
 * Get country name from MMSI number.
 * Derives the MID (first 3 digits) and looks it up.
 */
export function getCountryFromMMSI(mmsi: string | number): string {
